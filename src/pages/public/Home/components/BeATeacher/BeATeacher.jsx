    ...
    <div className="BeATeacher pt-5">
      <Row className="p-0 m-0">
        ...
        <Col xs={12} md={6} className="text-center">
          <h2>{t("BeATeacherTitle")}</h2>
          <p className="pb-3">{t("MentorText")}</p>
          <a
            href="mailto:admin@learning.com"
            className="ButtonPrimary cta btn btn-lg"
          >
            {t("BeATeacherButton")}
          </a>
        </Col>
