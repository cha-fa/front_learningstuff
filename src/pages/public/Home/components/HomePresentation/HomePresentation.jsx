...
const HomePresentation = () => {
  ...
  return (
    <section className="HomePresentation">
      <Row className="Company_Cores p-5">
        <Col>
      ...
      <Row className="Courses_CTA">
        ...
        <Col xs={12} md={6} className="text-center">
          <h2 className="display-4 mb-3">
            {t("learn_a_lot_of_stuff")}
          </h2>
          <h4 className="mb-3">
            {t("in_charge_of_future")}
          </h4>
          <Link to="/courses" className="ButtonPrimary mt-3 mb-5 cta btn btn-lg">
            {t("home:ctacourses")}
          </Link>
        </Col>
      </Row>
